...
const FileUpload = React.createClass({
    ...
    _updateProps(props) {
        ...
        this.textBeforeFiles = options.textBeforeFiles || false //make this true to add text fields before file mocks
    ...
    commonUpload() {
        ...
        /*If we need to add fields before file mocks append here*/
        ...
        /*If we need to add fields after file mocks append here*/
        if (!this.textBeforeFiles) {
            formData = this.appendFieldsToFormData(formData);
        }
